...
const ProductComponent = () => {
  const [activeTab, setActiveTab] = useState('overview');
  const { addToCart, cart } = useCart(); // Extracting addToCart and cart from useCart
          ...
          >
            ...
            <div className="flex justify-between items-center mt-6">
              ...
              <button
                ...
                className="bg-yellow-500 text-black py-2 px-4 rounded-lg font-bold hover:bg-yellow-600 transition"
              >
                Add to cart
              </button>
            </div>
